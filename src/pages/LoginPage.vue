...
<template>
  <div class="auth-bg">
    <div class="auth-card">
      ...
      <div class="mb-6">
        <h1 class="text-[22px] font-semibold text-gray-900 mb-1">Вход</h1>
        <p class="text-sm text-gray-500">Войдите в свой аккаунт, чтобы продолжить</p>
      </div>
      ...
      <p class="text-center text-sm text-gray-500 mt-6">
        Нет аккаунта?
        <RouterLink to="/register" class="text-blue-600 font-medium hover:text-blue-700">Зарегистрироваться</RouterLink>
      </p>
    </div>
